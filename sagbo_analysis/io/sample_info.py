...
from .io import generate_config
@dataclass
class SampleInfo:
    ...
    darks_path: str
    processing_dir: str
    pca_flat_file: str = os.path.join(processing_dir, 'PCA_flats.h5')
    config_file:str = os.path.join(processing_dir, 'config.ini')
    ...
    def sample_name(self):
        return self.sample_dir.split('/')[-1]
